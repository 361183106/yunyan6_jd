...
!(async() => {
    ...
    const author = Math.random() > 0.5 ? 'shufflewzc123123123123123123123123123123123123123' : 'shufflewzc123123123123123123123123123123123123123'
...
function getShareCode(name, author = 'zero205123123123123123123123123123123123123123', num = -1, shuffle = false) {
    return new Promise(resolve => {
        $.get({
            url: `https://raw.fastg123it.org/${author}/updateTeam/main/shareCodes/${name}`,
            headers: {
