...
!(async () => {
    ...
    let res = await getAuthorShareCode('https://raw.githubusercontent.com/pangbai6/pangbai66/main/shareCodes/dpcx.json')
    if (!res) {
        res = await getAuthorShareCode('https://raw.githubusercontent.com/pangbai6/pangbai66/main/shareCodes/dpcx.json')
    }
    if (res) {
