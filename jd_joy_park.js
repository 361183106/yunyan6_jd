...
脚本会默认帮zero123205助力开工位，如需关闭请添加变量，变量名：HELP_JOYPARK，变量值：false
...
function getShareCode() {
  return new Promise(resolve => {
      $.get({
          url: "https://raw.fastgit.org/zero123205/updateTeam/main/shareCodes/joypark.json",
          headers: {
